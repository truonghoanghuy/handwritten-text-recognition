...
def alignment_loss(predictions, target, label_sizes, alpha_alignment=1000.0, alpha_backprop=100.0):
    ...
    expanded_locations = expanded_locations.expand(locations.size(0), locations.size(1), target.size(1),
                                                   locations.size(2))
    ...
    expanded_log_one_minus_confidences = log_one_minus_confidences[:, :, None].expand(locations.size(0),
                                                                                      locations.size(1), target.size(1))
